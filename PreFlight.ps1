<#
    .SYNOPSIS
    Script to perform pre-migration checks in an Exchange Hybrid environment.

    .DESCRIPTION
    It checks for basic migration pre-requisites, such as:  
    ...
    .PARAMETER Autoload
    Autoload mail users in the tool.

    .EXAMPLE
    PS C:\Preflight> .\Preflight.ps1 
    Runs the script in the local path.
